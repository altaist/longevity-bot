...
//$theme->moduleComponent("store", "service/form-service-edit", $data);
...
<div class="my-5">
	<div class="title3">
<?php $theme->sectionTitle("Активности")?>
	</div>
	<div>
		<div class="my-3"><a href="#" @click.prevent="onCreateChildModal()">Добавить новую активность</a></div>
	</div>
	<div class="row my-3">
