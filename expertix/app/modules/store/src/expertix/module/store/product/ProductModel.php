...
class ProductModel extends BaseModel
{
	...
	function getProductsList($filter)
	{
		...
		$sql = "select p.*, p.productKey as `key`, pa.fav, pa.comments from store_product p left join store_product_action pa on p.productId=pa.productId where $filter_sql and isDeleted=0 order by p.productId desc";
