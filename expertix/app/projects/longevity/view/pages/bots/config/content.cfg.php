...
return [[
    "1" => [
        ...
        "ru" => [
            "items" => [
                ["text" => "Доброе утро! Как самочувствие?", "actions"=>[["Хорошее", "like"], ["Плохое", "dislike"]], "answers"=>["Ну и отлично!", "Жаль, но что поделать"] ],
                ["text" => "Вы проснулись? Как спалось?", "actions"=>"Спалось хорошо; Часто просыпался", "answers"=>"Ну и здорово!"],
                ["text" => "Привет! Что будешь делать сегодня?" , "actions"=>["Погуляю", "Не знаю, чем заняться" ]]
            ],
            "default" => [
                "text_after_answer" => "Спасибо за ответ! Хорошего вам дня!",
                "text_after_1" => "Вы выбрали like",
                "text_after_2" => "Вы выбрали dislike",
                "text_after_3" => "Вы выбрали dont know",
