...
class BotManager implements IBotContext
{
	...
	public function getDefaultCommand(){
		return new BotCommand(["method" => "defaultCommand"]);
	}
	...
	{
		return $this->getTransport()->getMessageChatId() .  ($this->getConfig()->get("complex_chat_id") ? "_" . $this->getBotId() : "");
	}
